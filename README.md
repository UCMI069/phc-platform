...
```bash
# Development mode with auto-reloading and instant preview
npm run dev
...
- 💰 **Fund Transfers** - Easy peer-to-peer fund transfers
- 📊 **Transaction History** - Detailed transaction tracking and reports
