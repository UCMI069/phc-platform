-- ============================================
-- PHC Platform — Neon Database Migration
...
-- Create profile + account on signup
...
BEGIN
    ...
    VALUES (p_user_id, p_first_name, p_last_name, p_email)
    ...
    IF NOT EXISTS (SELECT 1 FROM public.accounts WHERE user_id = p_user_id) THEN
        ...
        VALUES (p_user_id, p_account_type, 0);
    END IF;
END;
$$;
...
CREATE INDEX IF NOT EXISTS idx_upgrade_requests_user_id ON public.account_upgrade_requests(user_id);
